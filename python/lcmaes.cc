...
BOOST_PYTHON_MODULE(lcmaes)
{
  ...
  class_<CMAParameters<GenoPheno<NoBoundStrategy>>>("CMAParametersNB","CMAParameters object for problems with unbounded function parameters")
    ...
    .def("set_elitism",&CMAParameters<GenoPheno<NoBoundStrategy>>::set_elitism,"set elitism")
    ...
    .def("set_no_progress_steps",&CMAParameters<GenoPheno<NoBoundStrategy>>::set_no_progress_steps,"set the maximum number of steps without progress")
    .def("get_no_progress_steps",&CMAParameters<GenoPheno<NoBoundStrategy>>::get_no_progress_steps,"return the maximum number of steps without progress")
  ...
  class_<CMAParameters<GenoPheno<pwqBoundStrategy>>>("CMAParametersPB","CMAParameters object for problems with bounded parameters")
    ...
    .def("set_elitism",&CMAParameters<GenoPheno<pwqBoundStrategy>>::set_elitism,"set elitism")
  ...
  class_<CMAParameters<GenoPheno<NoBoundStrategy,linScalingStrategy>>>("CMAParametersNBS","CMAParameters object for problems with scaled parameters")
    ...
    .def("set_elitism",&CMAParameters<GenoPheno<NoBoundStrategy,linScalingStrategy>>::set_elitism,"set elitism")
    ...
    .def("set_no_progress_steps",&CMAParameters<GenoPheno<NoBoundStrategy,linScalingStrategy>>::set_no_progress_steps,"set the maximum number of steps without progress")
    .def("get_no_progress_steps",&CMAParameters<GenoPheno<NoBoundStrategy,linScalingStrategy>>::get_no_progress_steps,"return the maximum number of steps without progress")
  ...
  class_<CMAParameters<GenoPheno<pwqBoundStrategy,linScalingStrategy>>>("CMAParametersPBS","CMA Parameters for problems with bounded and rescaled parameters")
    ...
    .def("set_elitism",&CMAParameters<GenoPheno<pwqBoundStrategy,linScalingStrategy>>::set_elitism,"set elitism")
    ...
    .def("set_no_progress_steps",&CMAParameters<GenoPheno<pwqBoundStrategy,linScalingStrategy>>::set_no_progress_steps,"set the maximum number of steps without progress")
    .def("get_no_progress_steps",&CMAParameters<GenoPheno<pwqBoundStrategy,linScalingStrategy>>::get_no_progress_steps,"return the maximum number of steps without progress")
  ...
  class_<CMASolutions>("CMASolutions","Object for holding results and intermediate evolving solutions from a running optimizer")
    ...
    .def("best_seen_candidate",&CMASolutions::get_best_seen_candidate,"returns the best seen candidate solution")
